...
public class signup_business_emailcheck extends HttpServlet {
    ...
    throws ServletException, IOException {
       ...
       System.out.println("Business Name After Replacing"+business_name);
            ...
            com.server.Constants.logger.error("Error in signupbus_emailcheck.java while checking business"+e.getMessage());
       }
                        ...
                        if(itemName==null||itemName==""){
                           // path = "C:\\Documents and Settings\\admin\\My Documents\\Paid Punch\\uploaded files\\" + "images\\paidpunchlogo.png";
                            ...
                            com.server.Constants.logger.info("********************Actual Uploaded Path"+actualFolderPath);
                              ...
                              com.server.Constants.logger.error("Error while uploading Logo Image : "+e.getMessage().toString());
                    }
                }       //else
            }           //while(itr)
    ...
    public void compress_file(File newFile,String ImageString, String imagePath) throws FileNotFoundException, IOException{
    ...
    public String getEmailBusiness(String emailid,String businessname) throws ServletException{//,String businessname) throws ServletException{
            ...
            try {
                            ...
                            com.server.Constants.logger.error("Error in Sql in signup_business_emailcheck.java in getEmailBusiness "+e.getMessage());
                            status = "02";
                      ...
                      try {
                          ...
                          db.closeConnection();
                            ...
                            com.server.Constants.logger.error("Error in closing SQL in signup_business_emailcheck.java"+e.getMessage());
                      }
                   }
                   return status;
                }
