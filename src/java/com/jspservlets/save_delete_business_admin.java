...
public class save_delete_business_admin extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet save_delete_business_admin</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet save_delete_business_admin at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
            */
        } finally { 
    ...
    public String updateExpiryDate(String businessid, String expdate) throws ServletException{
            ...
            try {
                               ...
                               String updatePasswordQuery = "Update punch_card set expiry_date = '" + java.sql.Date.valueOf(expdate) + "' where business_userid ="+busid;
                  ...
                  com.server.Constants.logger.error("Error in Sql in savedeletebusiness.java in updateExpiryDate "+e.getMessage());
          ...
          System.out.println("<br>"+sqlDate);
            ...
            try {
                              ...
                              // String updatePasswordQuery = "delete from business_users where business_userid = "+busid;
                               // String updatePasswordQuery = "Update punch_card set expiry_date = '" + sqlDate + "' where business_userid ="+busid;
                               com.server.Constants.logger.info("The query is "+updatePasswordQuery);
                               System.out.println("The query is "+updatePasswordQuery);
                               stmt.executeUpdate(updatePasswordQuery);
                               codeFlag = "04";
