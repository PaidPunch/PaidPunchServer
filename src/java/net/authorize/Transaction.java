...
public abstract class Transaction implements Serializable {
     ...
     * 
     * Character that will be used to separate fields in the transaction response. The system will use the character
     * passed in this field or the value stored in the Merchant Interface if no value is passed.
     * 
     ...
     * 
     * Character that will be used to encapsulate the fields in the transaction response. The system will use the
     * character passed in this field or the value stored in the Merchant Interface if no value is passed.
     */
