...
public class TransactionCommunication {
    ...
    public Vector makePaymentAuthCapture(String profileIdfromApp, String paymentProfileIdfromApp, String amount)
            throws Exception {
        ...
        com.server.Constants.logger.info("CustomerProfile ID : " + profileIdfromApp + "Payment Profile Id : "
                + paymentProfileIdfromApp + " Amount : " + amount);
        Order order;
        // Payment payment;
        PaymentTransaction paymentTransaction;
        ...
        /*
         * // create order item OrderItem orderItem = OrderItem.createOrderItem();
         * orderItem.setItemDescription(utd.getItemDescription()); orderItem.setItemId(utd.getItemId());
         * orderItem.setItemName(utd.getItemName()); orderItem.setItemPrice(utd.getItemPrice());
         * orderItem.setItemQuantity(utd.getItemQuantity()); orderItem.setItemTaxable(true);
         * order.addOrderItem(orderItem);
         * 
         * 
         * for(int i = 0; i <= 2; i++) { order.addOrderItem(orderItem); }
         */
        ...
        net.authorize.cim.Transaction transaction = utd.getMerchant().createCIMTransaction(
                TransactionType.CREATE_CUSTOMER_PROFILE_TRANSACTION);
