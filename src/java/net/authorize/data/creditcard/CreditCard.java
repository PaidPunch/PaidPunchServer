...
public class CreditCard implements Serializable {
    ...
    public void setExpirationDate(String expiration_date) {
        this.expirationDate = net.authorize.util.DateUtil.getDateFromFormattedDate(expiration_date,
                ARB_EXPIRY_DATE_FORMAT);
        System.out.println("Expiry Date : " + this.expirationDate);
        extractMonthYearFromExpiration();
    }
    ...
    /**
     * @param cardCodeVerification
     *            the cardCodeVerification to set
    ...
    /**
     * @param cardholderAuthenticationIndicator
     *            the cardholderAuthenticationIndicator to set
     */
    public void setCardholderAuthenticationIndicator(
            String cardholderAuthenticationIndicator) {
        // System.out.println(cardholderAuthenticationIndicator);
    ...
    public void setCardholderAuthenticationValue(String cardholderAuthenticationValue) {
        // System.out.println(cardholderAuthenticationValue);
