...
public class PaymentTransaction {
     ...
     *            the customerPaymentProfileId to set
     */
     ...
     *            the customerShippingAddressId to set
     */
    ...
    /**
     * @param creditCardNumberMasked
     *            the creditCardNumberMasked to set
     */
    ...
    /**
     * @param bankRoutingNumberMasked
     *            the bankRoutingNumberMasked to set
     */
     ...
     *            the bankAccountNumberMasked to set
     */
