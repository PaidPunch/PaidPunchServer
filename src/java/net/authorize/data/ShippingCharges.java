...
public class ShippingCharges implements Serializable {
    ...
    public void setTaxAmount(String taxAmount) {
        if (StringUtils.isNotEmpty(taxAmount)) {
            this.taxAmount = new BigDecimal(taxAmount).setScale(Transaction.CURRENCY_DECIMAL_PLACES,
    ...
    public void setFreightAmount(String freightAmount) {
        if (StringUtils.isNotEmpty(freightAmount)) {
            this.freightAmount = new BigDecimal(freightAmount).setScale(Transaction.CURRENCY_DECIMAL_PLACES,
                    BigDecimal.ROUND_HALF_UP);
        }
    }
    ...
    public void setDutyAmount(String dutyAmount) {
        if (StringUtils.isNotEmpty(dutyAmount)) {
            this.dutyAmount = new BigDecimal(dutyAmount).setScale(Transaction.CURRENCY_DECIMAL_PLACES,
                    BigDecimal.ROUND_HALF_UP);
        }
    }
