...
public class OrderItem implements Serializable {
    ...
    public void setItemQuantity(String itemQuantity) {
        if (StringUtils.isNotEmpty(itemQuantity)) {
            this.itemQuantity = new BigDecimal(itemQuantity).setScale(Transaction.QUANTITY_DECIMAL_PLACES,
    ...
    public void setItemPrice(String itemPrice) {
        if (StringUtils.isNotEmpty(itemPrice)) {
            this.itemPrice = new BigDecimal(itemPrice).setScale(Transaction.CURRENCY_DECIMAL_PLACES,
                    BigDecimal.ROUND_HALF_UP);
        }
    }
