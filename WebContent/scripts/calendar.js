...
function showCalender(elPos, tgtEl, tgtE2)
{
	...
	else
	{
        ...
        if (document.getElementById(tgtE2))
	{
                targetE2 = document.getElementById(tgtE2);
	}
	else
	{
            	if (document.forms[0].elements[tgtE2])
		{
                       targetE2 = document.forms[0].elements[tgtE2];
		}
	}
