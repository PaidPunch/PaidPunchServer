...
<%
    ...
    String transaction_date="",transaction_time="",isFreePunch="";
    ...
    String email_id = "";
            ...
            try {
                               ...
                               //String query = "Select download_date,download_time,username from punchcard_download,app_user where punchcard_download.punch_card_id="+pid+" and app_user.user_id= punchcard_download.app_user_id;";
                              // String query = "Select download_date,download_time,app_user.email_id,app_user.username from punchcard_download,app_user where punchcard_download.punch_card_id="+pid+" and app_user.user_id= punchcard_download.app_user_id;";
                               String query = "Select download_date,download_time,app_user.email_id,app_user.username,punchcard_download.isfreepunch from punchcard_download,app_user where punchcard_download.punch_card_id="+pid+" and app_user.user_id= punchcard_download.app_user_id Order By download_date desc, download_time desc;";
                           ...
                           %>
                              <tr class="normalRow" align="center">
                                  <td width="100%" style="font-family: Calibri; font-size: 20px; padding: 5px;">No Punch Cards Issued</td>
